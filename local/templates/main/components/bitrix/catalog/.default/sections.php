...
if (isset($_REQUEST['sort']) && in_array($_REQUEST['sort'], $allowSort)) {
    $sort = $_REQUEST['sort'];
}
            ...
            <div class="catalog__grid-item catalog__grid-item_2">
                <div class="menu-a catalog__menu catalog__menu_dates">
                    <div class="menu-a__list owl-carousel">
                        ...
                        global $arrSuppleis;
                        $isFirst = true;
                        foreach ($arrSuppleis as $item):?>
                            <div class="menu-a__item <?= ($isFirst ? 'active' : '') ?>">
                                <a href="javascript:void(0)" class="menu-a__link">
                                    <?= $item['NAME'] ?>
                                </a>
                            </div>
                            <?php
                        ...
                        <div class="bar-a__grid-item bar-a__grid-item_1">
                            <div class="bar-a__item bar-a__item_sort">
                                <select class="bar-a__select">
                                    ...
                                    if ($sort == 'price'): ?>selected<?php
                                    endif ?>
                                            data-url="<?= $APPLICATION->GetCurPageParam("sort=price", ['sort', 'PAGE_1']
                                            ) ?>">
                                        По цене
                                    </option>
                                    <option value="2" <?php
                                    if ($sort == 'name'): ?>selected<?php
                                    endif ?>
                                            data-url="<?= $APPLICATION->GetCurPageParam("sort=name", ['sort', 'PAGE_1']
                                            ) ?>">
                                        По названию
                                    </option>
                                    <option value="2" <?php
                                    if ($sort == 'availability'): ?>selected<?php
                                    endif ?>
