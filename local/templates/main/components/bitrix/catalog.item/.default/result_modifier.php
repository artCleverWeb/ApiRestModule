...
$item['DISPLAY_PROPERTIES']['AMOUNT_IN_PALLET']['DISPLAY_VALUE'] = $item['DISPLAY_PROPERTIES']['AMOUNT_IN_PALLET']['DISPLAY_VALUE'] > 0 ? $item['DISPLAY_PROPERTIES']['AMOUNT_IN_PALLET']['DISPLAY_VALUE'] : 1;
$item['DISPLAY_PROPERTIES']['AMOUNT_IN_PACK']['DISPLAY_VALUE'] = $item['DISPLAY_PROPERTIES']['AMOUNT_IN_PACK']['DISPLAY_VALUE'] > 0 ? $item['DISPLAY_PROPERTIES']['AMOUNT_IN_PACK']['DISPLAY_VALUE'] : 1;
$item['PRODUCT']['QUANTITY'] = $item['PRODUCT']['QUANTITY'] > 0 ? $item['PRODUCT']['QUANTITY'] : 1;
