...
?>
        <div class="bar-a__grid-item bar-a__grid-item_2" data-pagination-num="<?=$navParams['NavNum']?>">
            <!-- pagination-container -->
            <?=$arResult['NAV_STRING']?>
            <!-- pagination-container -->
        </div>
...
<div class="catalog__products" data-entity="<?= $containerName ?>">
    <div class="catalog__products-table" data-entity="items-row">
